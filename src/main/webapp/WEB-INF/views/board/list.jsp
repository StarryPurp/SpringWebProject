...
<%@ include file="../include/member_menu.jsp" %>
    ...
    <form name="form1" method="post" action="${path}/board/list.do">
    	...
    	<c:if test="${sessionScope.userId != null}">
    		<button type="button" id="btnWrite" class="btn-1">글쓰기</button>
    	</c:if>
    </form>
     ...
     ${map.count}개의 게시물이 있습니다.
        ...
        <tr>
            ...
            <td>
              <a href="${path}/board/view.do?bno=${row.bno}&curPage=${map.boardPager.curPage}
                                                           &searchOption=${map.searchOption}
                                                           &kerword=${map.keyword}">${row.title}</a> 
        ...
        <tr>
        	<td colspan="5">
        		...
        		<c:out value="${map.boardPager.blockBegin}"/>
        		<c:out value="${map.boardPager.blockEnd}"/>
